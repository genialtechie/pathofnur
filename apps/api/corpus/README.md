...
- The default SQL schema assumes 768-dimensional embeddings. Keep `EMBEDDING_DIMENSIONS=768` unless you also update `apps/api/sql/retrieval_passages.sql`.
