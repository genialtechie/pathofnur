...
- local source JSON in `server/corpus/source`
...
`server/sql/retrieval_passages.sql` to match before seeding.

See `server/corpus/README.md` and `server/sql/retrieval_passages.sql`.
